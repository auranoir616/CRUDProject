...
?>
    ...
    <div class="row g-0 position-relative" id="container-post">
      <div>
        <a @if($data->user_id == auth()->id()) href="/myprofile" @endif href="/profile/{{$data->user_id}}-{{$data->name}}" class="link-light link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover"><b>{{$data->name}}</b></a>
         <br>
