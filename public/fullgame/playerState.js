...
export class Rolling extends State {
    ...
    //kondisi masuk ke state lain saat sedang Rolling
    handlerInput(input){
        ...
        if(!input.includes('s') && this.game.player.onGround() || this.game.energy === 0){
            this.game.player.setState(states.RUNNING,1)
        }
...
export class Diving extends State {
    ...
    //kondisi masuk ke state lain saat sedang Diving
    handlerInput(input){
        this.game.particles.unshift(new Fire(this.game, this.game.player.x + this.game.player.width * 0.5, this.game.player.y + this.game.player.height))
       ...
       else if(input.includes('s') && this.game.player.onGround() && this.game.energy !== 0){
            this.game.player.setState(states.ROLLING,2)
       }
